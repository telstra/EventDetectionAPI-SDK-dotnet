...
namespace com.telstra.eventdetection.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class UnregisterRequestObj :  IEquatable<UnregisterRequestObj>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="UnregisterRequestObj" /> class.
        /// </summary>
        /// <param name="NotificationURL">Notification URL.</param>
        /// <param name="Msisdns">list of msisdns.</param>
        public UnregisterRequestObj(string NotificationURL = default(string), List<string> Msisdns = default(List<string>))
        {
        ...
        {
            return this.Equals(input as UnregisterRequestObj);
        }

        /// <summary>
        /// Returns true if UnregisterRequestObj instances are equal
        /// </summary>
        /// <param name="input">Instance of UnregisterRequestObj to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(UnregisterRequestObj input)
        {
            if (input == null)
                return false;
