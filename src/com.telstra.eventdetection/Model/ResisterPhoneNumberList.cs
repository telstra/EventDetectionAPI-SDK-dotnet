...
namespace com.telstra.eventdetection.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class ResisterPhoneNumberList :  IEquatable<ResisterPhoneNumberList>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ResisterPhoneNumberList" /> class.
        /// </summary>
        /// <param name="Msisdns">MSISDNs array.</param>
        public ResisterPhoneNumberList(List<Test> Msisdns = default(List<Test>))
        {
        ...
        /// MSISDNs array
        /// </summary>
        /// <value>MSISDNs array</value>
        [DataMember(Name="msisdns", EmitDefaultValue=false)]
        public List<Test> Msisdns { get; set; }
        ...
        {
            return this.Equals(input as ResisterPhoneNumberList);
        }

        /// <summary>
        /// Returns true if ResisterPhoneNumberList instances are equal
        /// </summary>
        /// <param name="input">Instance of ResisterPhoneNumberList to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ResisterPhoneNumberList input)
        {
            if (input == null)
                return false;
