...
namespace com.telstra.eventdetection.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class PushNotificationObj :  IEquatable<PushNotificationObj>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="PushNotificationObj" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected PushNotificationObj() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="PushNotificationObj" /> class.
        /// </summary>
        /// <param name="EventId">Event name (required).</param>
        /// <param name="Msisdn">MSISDN (required).</param>
        /// <param name="EventDate">Timestamp indicating when the event occured (required).</param>
        public PushNotificationObj(string EventId = default(string), string Msisdn = default(string), string EventDate = default(string))
        {
            // to ensure "EventId" is required (not null)
            if (EventId == null)
            {
                throw new InvalidDataException("EventId is a required property for PushNotificationObj and cannot be null");
            }
            else
            {
            ...
            if (Msisdn == null)
            {
                throw new InvalidDataException("Msisdn is a required property for PushNotificationObj and cannot be null");
            }
            else
            {
                this.Msisdn = Msisdn;
            ...
            if (EventDate == null)
            {
                throw new InvalidDataException("EventDate is a required property for PushNotificationObj and cannot be null");
            }
            else
            {
        ...
        /// </summary>
        /// <value>Timestamp indicating when the event occured</value>
        ...
        {
            return this.Equals(input as PushNotificationObj);
        }

        /// <summary>
        /// Returns true if PushNotificationObj instances are equal
        /// </summary>
        /// <param name="input">Instance of PushNotificationObj to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(PushNotificationObj input)
        {
            if (input == null)
                return false;
