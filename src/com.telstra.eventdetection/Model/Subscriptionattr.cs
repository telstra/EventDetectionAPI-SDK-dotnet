...
namespace com.telstra.eventdetection.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class Subscriptionattr :  IEquatable<Subscriptionattr>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="Subscriptionattr" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected Subscriptionattr() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="Subscriptionattr" /> class.
        /// </summary>
        /// <param name="Msisdn">MSISDN (required).</param>
        /// <param name="Events">Array of subscribed events (required).</param>
        /// <param name="CarrierName">Carrier name for the MSISDN (required).</param>
        public Subscriptionattr(string Msisdn = default(string), List<string> Events = default(List<string>), string CarrierName = default(string))
        {
            // to ensure "Msisdn" is required (not null)
            if (Msisdn == null)
            {
                throw new InvalidDataException("Msisdn is a required property for Subscriptionattr and cannot be null");
            }
            else
            {
                this.Msisdn = Msisdn;
            ...
            if (Events == null)
            {
                throw new InvalidDataException("Events is a required property for Subscriptionattr and cannot be null");
            }
            else
            {
                this.Events = Events;
            ...
            if (CarrierName == null)
            {
                throw new InvalidDataException("CarrierName is a required property for Subscriptionattr and cannot be null");
            }
            else
            {
        ...
        /// </summary>
        /// <value>Array of subscribed events</value>
        ...
        /// </summary>
        /// <value>Carrier name for the MSISDN</value>
        ...
        {
            return this.Equals(input as Subscriptionattr);
        }

        /// <summary>
        /// Returns true if Subscriptionattr instances are equal
        /// </summary>
        /// <param name="input">Instance of Subscriptionattr to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(Subscriptionattr input)
        {
            if (input == null)
                return false;
