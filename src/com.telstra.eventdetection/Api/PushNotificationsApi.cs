...
namespace com.telstra.eventdetection.Api
{
    /// <summary>
    ...
    public interface IPushNotificationsApi : IApiAccessor
    {
        ...
        /// <param name="body">Application Id, MSISDN, Event Id and Event Date</param>
        /// <returns>PushNotificationObj</returns>
        ...
        /// <param name="contentType">application/json</param>
        /// <param name="body">Application Id, MSISDN, Event Id and Event Date</param>
        /// <returns>ApiResponse of PushNotificationObj</returns>
        ApiResponse<PushNotificationObj> PushNotificationsWithHttpInfo (string contentType, NotificationPayload body);
        ...
        /// <param name="contentType">application/json</param>
        /// <param name="body">Application Id, MSISDN, Event Id and Event Date</param>
        /// <returns>Task of PushNotificationObj</returns>
        System.Threading.Tasks.Task<PushNotificationObj> PushNotificationsAsync (string contentType, NotificationPayload body);
        ...
        /// <param name="contentType">application/json</param>
        /// <param name="body">Application Id, MSISDN, Event Id and Event Date</param>
        /// <returns>Task of ApiResponse (PushNotificationObj)</returns>
        System.Threading.Tasks.Task<ApiResponse<PushNotificationObj>> PushNotificationsAsyncWithHttpInfo (string contentType, NotificationPayload body);
    ...
    {
        private com.telstra.eventdetection.Client.ExceptionFactory _exceptionFactory = (name, response) => null;
        ...
        public PushNotificationsApi(String basePath)
        {
            ...
            ExceptionFactory = com.telstra.eventdetection.Client.Configuration.DefaultExceptionFactory;
        }
        ...
        /// <returns></returns>
        public PushNotificationsApi(Configuration configuration = null)
        {
        ...
        /// </summary>
        public com.telstra.eventdetection.Client.ExceptionFactory ExceptionFactory
        {
            get
            {
        ...
        /// <summary>
        /// Push event notifications Push event notifications to the notification URL configured during the MSISDN registration process
        /// </summary>
        /// <exception cref="com.telstra.eventdetection.Client.ApiException">Thrown when fails to make API call</exception>
        /// <param name="contentType">application/json</param>
        /// <param name="body">Application Id, MSISDN, Event Id and Event Date</param>
        /// <returns>PushNotificationObj</returns>
        public PushNotificationObj PushNotifications (string contentType, NotificationPayload body)
        {
             ApiResponse<PushNotificationObj> localVarResponse = PushNotificationsWithHttpInfo(contentType, body);
        ...
        /// <param name="body">Application Id, MSISDN, Event Id and Event Date</param>
        /// <returns>ApiResponse of PushNotificationObj</returns>
        public ApiResponse< PushNotificationObj > PushNotificationsWithHttpInfo (string contentType, NotificationPayload body)
        {
            // verify the required parameter 'contentType' is set
            if (contentType == null)
                throw new ApiException(400, "Missing required parameter 'contentType' when calling PushNotificationsApi->PushNotifications");
            // verify the required parameter 'body' is set
            if (body == null)
                throw new ApiException(400, "Missing required parameter 'body' when calling PushNotificationsApi->PushNotifications");

            var localVarPath = "/v1/eventdetection/events/notifications";
            ...
            {
                Exception exception = ExceptionFactory("PushNotifications", localVarResponse);
                if (exception != null) throw exception;
            }

            return new ApiResponse<PushNotificationObj>(localVarStatusCode,
                localVarResponse.Headers.ToDictionary(x => x.Name, x => x.Value.ToString()),
                (PushNotificationObj) Configuration.ApiClient.Deserialize(localVarResponse, typeof(PushNotificationObj)));
        }
        ...
        /// <param name="body">Application Id, MSISDN, Event Id and Event Date</param>
        /// <returns>Task of PushNotificationObj</returns>
        public async System.Threading.Tasks.Task<PushNotificationObj> PushNotificationsAsync (string contentType, NotificationPayload body)
        {
             ApiResponse<PushNotificationObj> localVarResponse = await PushNotificationsAsyncWithHttpInfo(contentType, body);
             return localVarResponse.Data;
        ...
        /// <param name="body">Application Id, MSISDN, Event Id and Event Date</param>
        /// <returns>Task of ApiResponse (PushNotificationObj)</returns>
        public async System.Threading.Tasks.Task<ApiResponse<PushNotificationObj>> PushNotificationsAsyncWithHttpInfo (string contentType, NotificationPayload body)
        {
            // verify the required parameter 'contentType' is set
            if (contentType == null)
                throw new ApiException(400, "Missing required parameter 'contentType' when calling PushNotificationsApi->PushNotifications");
