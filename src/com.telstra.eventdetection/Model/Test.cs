...
namespace com.telstra.eventdetection.Model
{
    ...
    public partial class Test :  IEquatable<Test>, IValidatableObject
    {
        ...
        /// <param name="Description">description about the registration status.</param>
        /// <param name="CarrierName">carrier name for the msisdn.</param>
        public Test(string Msisdn = default(string), string Description = default(string), string CarrierName = default(string))
        {
            this.Msisdn = Msisdn;
        ...
        /// </summary>
        /// <value>description about the registration status</value>
