...
namespace com.telstra.eventdetection.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class NotificationPayload :  IEquatable<NotificationPayload>, IValidatableObject
    {
        /// <summary>
        ...
        /// <param name="EventDate">Event timestamp.</param>
        public NotificationPayload(string AppId = default(string), string Msisdn = default(string), string EventId = default(string), string EventDate = default(string))
        {
            this.AppId = AppId;
            this.Msisdn = Msisdn;
        ...
        {
            return this.Equals(input as NotificationPayload);
        }

        /// <summary>
        /// Returns true if NotificationPayload instances are equal
        /// </summary>
        /// <param name="input">Instance of NotificationPayload to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(NotificationPayload input)
        {
            if (input == null)
                return false;
