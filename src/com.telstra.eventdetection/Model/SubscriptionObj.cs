...
namespace com.telstra.eventdetection.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class SubscriptionObj :  IEquatable<SubscriptionObj>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="SubscriptionObj" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected SubscriptionObj() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="SubscriptionObj" /> class.
        /// </summary>
        /// <param name="Msisdns">List of Phone numbers (required).</param>
        /// <param name="NotificationURL">Notification URL.</param>
        /// <param name="EventType">Event Type (required).</param>
        public SubscriptionObj(List<string> Msisdns = default(List<string>), string NotificationURL = default(string), string EventType = default(string))
        {
            // to ensure "Msisdns" is required (not null)
            if (Msisdns == null)
            {
                throw new InvalidDataException("Msisdns is a required property for SubscriptionObj and cannot be null");
            }
            else
            {
            ...
            if (EventType == null)
            {
                throw new InvalidDataException("EventType is a required property for SubscriptionObj and cannot be null");
            }
            else
            {
        ...
        [DataMember(Name="msisdns", EmitDefaultValue=false)]
        ...
        public override string ToString()
        {
            ...
            sb.Append("  Msisdns: ").Append(Msisdns).Append("\n");
        ...
        {
            return this.Equals(input as SubscriptionObj);
        }

        /// <summary>
        /// Returns true if SubscriptionObj instances are equal
        /// </summary>
        /// <param name="input">Instance of SubscriptionObj to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(SubscriptionObj input)
        {
            if (input == null)
                return false;
            ...
            return 
                (
                    this.Msisdns == input.Msisdns ||
                    this.Msisdns != null &&
                    this.Msisdns.SequenceEqual(input.Msisdns)
                ) && 
                (
        ...
        public override int GetHashCode()
        {
            unchecked // Overflow is fine, just wrap
            {
                ...
                if (this.Msisdns != null)
                    hashCode = hashCode * 59 + this.Msisdns.GetHashCode();
