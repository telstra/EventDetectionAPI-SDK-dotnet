...
using SwaggerDateConverter = com.telstra.eventdetection.Client.SwaggerDateConverter;

namespace com.telstra.eventdetection.Model
{
    /// <summary>
    /// Eventsattr
    /// </summary>
    [DataContract]
    public partial class Eventsattr :  IEquatable<Eventsattr>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="Eventsattr" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected Eventsattr() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="Eventsattr" /> class.
        /// </summary>
        /// <param name="Msisdn">MSISDN (required).</param>
        /// <param name="MobileServiceEvents">Array of mobile events (required).</param>
        public Eventsattr(string Msisdn = default(string), List<ServiceEventsAttr> MobileServiceEvents = default(List<ServiceEventsAttr>))
        {
            // to ensure "Msisdn" is required (not null)
            if (Msisdn == null)
            {
                throw new InvalidDataException("Msisdn is a required property for Eventsattr and cannot be null");
            }
            else
            {
                this.Msisdn = Msisdn;
            }
            // to ensure "MobileServiceEvents" is required (not null)
            if (MobileServiceEvents == null)
            {
                throw new InvalidDataException("MobileServiceEvents is a required property for Eventsattr and cannot be null");
            }
            else
            {
        ...
        /// </summary>
        /// <value>Array of mobile events</value>
        [DataMember(Name="mobileServiceEvents", EmitDefaultValue=false)]
        public List<ServiceEventsAttr> MobileServiceEvents { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("  MobileServiceEvents: ").Append(MobileServiceEvents).Append("\n");
            sb.Append("}\n");
            return sb.ToString();
        }
        ...
        {
            return this.Equals(input as Eventsattr);
        }

        /// <summary>
        /// Returns true if Eventsattr instances are equal
        /// </summary>
        /// <param name="input">Instance of Eventsattr to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(Eventsattr input)
        {
            if (input == null)
                return false;
            ...
            return 
                ...
                (
                    this.MobileServiceEvents == input.MobileServiceEvents ||
                    this.MobileServiceEvents != null &&
                    this.MobileServiceEvents.SequenceEqual(input.MobileServiceEvents)
                );
        }
        ...
        public override int GetHashCode()
        {
            unchecked // Overflow is fine, just wrap
            {
                ...
                if (this.MobileServiceEvents != null)
                    hashCode = hashCode * 59 + this.MobileServiceEvents.GetHashCode();
                return hashCode;
            }
        }
