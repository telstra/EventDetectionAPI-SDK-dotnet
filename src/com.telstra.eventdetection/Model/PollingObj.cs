...
namespace com.telstra.eventdetection.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class PollingObj :  IEquatable<PollingObj>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="PollingObj" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected PollingObj() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="PollingObj" /> class.
        /// </summary>
        /// <param name="Msisdns">Msisdns (required).</param>
        public PollingObj(List<string> Msisdns = default(List<string>))
        {
            // to ensure "Msisdns" is required (not null)
            if (Msisdns == null)
            {
                throw new InvalidDataException("Msisdns is a required property for PollingObj and cannot be null");
            }
            else
            {
        ...
        {
            return this.Equals(input as PollingObj);
        }

        /// <summary>
        /// Returns true if PollingObj instances are equal
        /// </summary>
        /// <param name="input">Instance of PollingObj to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(PollingObj input)
        {
            if (input == null)
                return false;
