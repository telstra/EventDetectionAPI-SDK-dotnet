...
namespace com.telstra.eventdetection.Test
{
    ...
    /// </remarks>
    [TestFixture]
    public class GetEventResponseTests
    {
        ...
        {
            // TODO uncomment below to test "IsInstanceOfType" GetEventResponse
            //Assert.IsInstanceOfType<GetEventResponse> (instance, "variable 'instance' is a GetEventResponse");
        }
