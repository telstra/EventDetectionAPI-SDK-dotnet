...
namespace com.telstra.eventdetection.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class PhoneNumberList :  IEquatable<PhoneNumberList>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="PhoneNumberList" /> class.
        /// </summary>
        /// <param name="Msisdns">MSISDN list.</param>
        public PhoneNumberList(List<string> Msisdns = default(List<string>))
        {
        ...
        {
            return this.Equals(input as PhoneNumberList);
        }

        /// <summary>
        /// Returns true if PhoneNumberList instances are equal
        /// </summary>
        /// <param name="input">Instance of PhoneNumberList to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(PhoneNumberList input)
        {
            if (input == null)
                return false;
