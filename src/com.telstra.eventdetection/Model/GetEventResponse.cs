...
namespace com.telstra.eventdetection.Model
{
    ...
    public partial class GetEventResponse :  IEquatable<GetEventResponse>, IValidatableObject
    {
        ...
        /// Initializes a new instance of the <see cref="GetEventResponse" /> class.
        /// </summary>
        /// <param name="EventType">Name of the event (required).</param>
        /// <param name="Msisdns">Array containing the object with evnt attributes (required).</param>
        public GetEventResponse(string EventType = default(string), List<Eventsattr> Msisdns = default(List<Eventsattr>))
        {
            // to ensure "EventType" is required (not null)
            if (EventType == null)
            {
                throw new InvalidDataException("EventType is a required property for GetEventResponse and cannot be null");
            }
            else
            {
            ...
            if (Msisdns == null)
            {
                throw new InvalidDataException("Msisdns is a required property for GetEventResponse and cannot be null");
            }
            else
            {
        ...
        /// </summary>
        /// <value>Array containing the object with evnt attributes</value>
        [DataMember(Name="msisdns", EmitDefaultValue=false)]
        public List<Eventsattr> Msisdns { get; set; }
