...
namespace com.telstra.eventdetection.Api
{
    ...
    /// </summary>
    public interface ILongPollApi : IApiAccessor
    {
        ...
        /// <param name="body">List of MSISDNs to pull the events</param>
        ...
        ApiResponse<GetEventResponse> LongpollWithHttpInfo (string eventType, PollingObj body);
        ...
        System.Threading.Tasks.Task<GetEventResponse> LongpollAsync (string eventType, PollingObj body);
        ...
        System.Threading.Tasks.Task<ApiResponse<GetEventResponse>> LongpollAsyncWithHttpInfo (string eventType, PollingObj body);
    ...
    /// Represents a collection of functions to interact with the API endpoints
    /// </summary>
    public partial class LongPollApi : ILongPollApi
    {
        private com.telstra.eventdetection.Client.ExceptionFactory _exceptionFactory = (name, response) => null;

        /// <summary>
        /// Initializes a new instance of the <see cref="LongPollApi"/> class.
        /// </summary>
        /// <returns></returns>
        public LongPollApi(String basePath)
        {
        ...
        /// <returns></returns>
        public LongPollApi(Configuration configuration = null)
        {
        ...
        /// <summary>
        /// Poll events Poll events for a given set of MSISDNs
        /// </summary>
        /// <exception cref="com.telstra.eventdetection.Client.ApiException">Thrown when fails to make API call</exception>
        /// <param name="eventType">Event Type</param>
        /// <param name="body">List of MSISDNs to pull the events</param>
        /// <returns>GetEventResponse</returns>
        public GetEventResponse Longpoll (string eventType, PollingObj body)
        {
             ApiResponse<GetEventResponse> localVarResponse = LongpollWithHttpInfo(eventType, body);
        ...
        /// <param name="body">List of MSISDNs to pull the events</param>
        /// <returns>ApiResponse of GetEventResponse</returns>
        public ApiResponse< GetEventResponse > LongpollWithHttpInfo (string eventType, PollingObj body)
        {
            // verify the required parameter 'eventType' is set
            if (eventType == null)
                throw new ApiException(400, "Missing required parameter 'eventType' when calling LongPollApi->Longpoll");
            // verify the required parameter 'body' is set
            if (body == null)
                throw new ApiException(400, "Missing required parameter 'body' when calling LongPollApi->Longpoll");
            ...
            {
                Exception exception = ExceptionFactory("Longpoll", localVarResponse);
                if (exception != null) throw exception;
            }

            return new ApiResponse<GetEventResponse>(localVarStatusCode,
                localVarResponse.Headers.ToDictionary(x => x.Name, x => x.Value.ToString()),
                (GetEventResponse) Configuration.ApiClient.Deserialize(localVarResponse, typeof(GetEventResponse)));
        }
        ...
        /// <param name="body">List of MSISDNs to pull the events</param>
        /// <returns>Task of GetEventResponse</returns>
        public async System.Threading.Tasks.Task<GetEventResponse> LongpollAsync (string eventType, PollingObj body)
        {
             ApiResponse<GetEventResponse> localVarResponse = await LongpollAsyncWithHttpInfo(eventType, body);
             return localVarResponse.Data;
        ...
        /// <param name="body">List of MSISDNs to pull the events</param>
        /// <returns>Task of ApiResponse (GetEventResponse)</returns>
        public async System.Threading.Tasks.Task<ApiResponse<GetEventResponse>> LongpollAsyncWithHttpInfo (string eventType, PollingObj body)
        {
            // verify the required parameter 'eventType' is set
            if (eventType == null)
                throw new ApiException(400, "Missing required parameter 'eventType' when calling LongPollApi->Longpoll");
