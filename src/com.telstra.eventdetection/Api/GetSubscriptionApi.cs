...
namespace com.telstra.eventdetection.Api
{
    ...
    /// </summary>
    public interface IGetSubscriptionApi : IApiAccessor
    {
        ...
        ApiResponse<GetSubscriptionResponse> GetSubscriptionWithHttpInfo (PhoneNumberList body);
        ...
        System.Threading.Tasks.Task<GetSubscriptionResponse> GetSubscriptionAsync (PhoneNumberList body);
        ...
        System.Threading.Tasks.Task<ApiResponse<GetSubscriptionResponse>> GetSubscriptionAsyncWithHttpInfo (PhoneNumberList body);
    ...
    /// Represents a collection of functions to interact with the API endpoints
    /// </summary>
    public partial class GetSubscriptionApi : IGetSubscriptionApi
    {
        private com.telstra.eventdetection.Client.ExceptionFactory _exceptionFactory = (name, response) => null;

        /// <summary>
        /// Initializes a new instance of the <see cref="GetSubscriptionApi"/> class.
        /// </summary>
        /// <returns></returns>
        public GetSubscriptionApi(String basePath)
        {
        ...
        /// <returns></returns>
        public GetSubscriptionApi(Configuration configuration = null)
        {
        ...
        /// <param name="body">List of subscribed phone numbers</param>
        /// <returns>ApiResponse of GetSubscriptionResponse</returns>
        public ApiResponse< GetSubscriptionResponse > GetSubscriptionWithHttpInfo (PhoneNumberList body)
        {
