...
namespace com.telstra.eventdetection.Api
{
    ...
    public interface IRegistrationApi : IApiAccessor
    {
        ...
        /// <exception cref="com.telstra.eventdetection.Client.ApiException">Thrown when fails to make API call</exception>
        /// <param name="body">Subscribe with a list of phone numbers, push notification URL (optional) and the event type.</param>
        /// <returns>ApiResponse of ResisterPhoneNumberList</returns>
        ApiResponse<ResisterPhoneNumberList> RegisterWithHttpInfo (SubscriptionObj body);
        /// <summary>
        /// Unregister
        /// </summary>
        /// <remarks>
        ...
        /// <param name="body">List of subscribed phone numbers and notification URL (optional)</param>
        /// <returns>ApiResponse of ResisterPhoneNumberList</returns>
        ApiResponse<ResisterPhoneNumberList> UnregisterWithHttpInfo (string eventType, UnregisterRequestObj body);
        ...
        System.Threading.Tasks.Task<ResisterPhoneNumberList> RegisterAsync (SubscriptionObj body);
        ...
        System.Threading.Tasks.Task<ApiResponse<ResisterPhoneNumberList>> RegisterAsyncWithHttpInfo (SubscriptionObj body);
        /// <summary>
        /// Unregister
        /// </summary>
        /// <remarks>
        ...
        /// <param name="body">List of subscribed phone numbers and notification URL (optional)</param>
        /// <returns>Task of ResisterPhoneNumberList</returns>
        System.Threading.Tasks.Task<ResisterPhoneNumberList> UnregisterAsync (string eventType, UnregisterRequestObj body);
        ...
        /// <param name="body">List of subscribed phone numbers and notification URL (optional)</param>
        /// <returns>Task of ApiResponse (ResisterPhoneNumberList)</returns>
        System.Threading.Tasks.Task<ApiResponse<ResisterPhoneNumberList>> UnregisterAsyncWithHttpInfo (string eventType, UnregisterRequestObj body);
    ...
    public partial class RegistrationApi : IRegistrationApi
    {
        ...
        /// <param name="body">Subscribe with a list of phone numbers, push notification URL (optional) and the event type.</param>
        /// <returns>ApiResponse of ResisterPhoneNumberList</returns>
        public ApiResponse< ResisterPhoneNumberList > RegisterWithHttpInfo (SubscriptionObj body)
        {
        ...
        /// <param name="body">List of subscribed phone numbers and notification URL (optional)</param>
        /// <returns>ApiResponse of ResisterPhoneNumberList</returns>
        public ApiResponse< ResisterPhoneNumberList > UnregisterWithHttpInfo (string eventType, UnregisterRequestObj body)
        {
