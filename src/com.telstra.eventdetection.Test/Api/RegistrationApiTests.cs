...
namespace com.telstra.eventdetection.Test
{
    ...
    public class RegistrationApiTests
    {
        ...
        public void RegisterTest()
        {
            ...
            //SubscriptionObj body = null;
            //var response = instance.Register(body);
            //Assert.IsInstanceOf<ResisterPhoneNumberList> (response, "response is ResisterPhoneNumberList");
        }
        ...
        public void UnregisterTest()
        {
            ...
            //UnregisterRequestObj body = null;
            //var response = instance.Unregister(eventType, body);
            //Assert.IsInstanceOf<ResisterPhoneNumberList> (response, "response is ResisterPhoneNumberList");
        }
