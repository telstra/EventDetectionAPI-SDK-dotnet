...
namespace com.telstra.eventdetection.Model
{
    ...
    public partial class GetSubscriptionResponse :  IEquatable<GetSubscriptionResponse>, IValidatableObject
    {
        ...
        protected GetSubscriptionResponse() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="GetSubscriptionResponse" /> class.
        /// </summary>
        /// <param name="NotificationURL">Notification URL.</param>
        /// <param name="Subscriptions">Array containing the object with values for phone number and subscription attributes (required).</param>
        public GetSubscriptionResponse(string NotificationURL = default(string), List<Subscriptionattr> Subscriptions = default(List<Subscriptionattr>))
        {
            // to ensure "Subscriptions" is required (not null)
            if (Subscriptions == null)
            {
                throw new InvalidDataException("Subscriptions is a required property for GetSubscriptionResponse and cannot be null");
            }
            else
            {
        ...
        /// </summary>
        /// <value>Array containing the object with values for phone number and subscription attributes</value>
        [DataMember(Name="subscriptions", EmitDefaultValue=false)]
        public List<Subscriptionattr> Subscriptions { get; set; }
