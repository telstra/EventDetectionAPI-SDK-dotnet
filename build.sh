...
${nuget_cmd} install src/com.telstra.eventdetection/packages.config -o packages;
...
echo "[INFO] Run 'mcs' to build bin/com.telstra.eventdetection.dll"
mcs -langversion:${langversion} -sdk:${sdk} -r:bin/Newtonsoft.Json.dll,bin/JsonSubTypes.dll,\
bin/RestSharp.dll,\
System.ComponentModel.DataAnnotations.dll,\
System.Runtime.Serialization.dll \
-target:library \
-out:bin/com.telstra.eventdetection.dll \
-recurse:'src/com.telstra.eventdetection/*.cs' \
-doc:bin/com.telstra.eventdetection.xml \
-platform:anycpu
...
then
  ...
  echo "[INFO] bin/com.telstra.eventdetection.dll was created successfully"
fi
