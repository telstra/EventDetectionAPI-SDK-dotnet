...
namespace com.telstra.eventdetection.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class ServiceEventsAttr :  IEquatable<ServiceEventsAttr>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ServiceEventsAttr" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected ServiceEventsAttr() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="ServiceEventsAttr" /> class.
        /// </summary>
        /// <param name="EventId">MSISDN (required).</param>
        /// <param name="EventDate">Array of subscribed events (required).</param>
        public ServiceEventsAttr(string EventId = default(string), string EventDate = default(string))
        {
            // to ensure "EventId" is required (not null)
            if (EventId == null)
            {
                throw new InvalidDataException("EventId is a required property for ServiceEventsAttr and cannot be null");
            }
            else
            {
            ...
            if (EventDate == null)
            {
                throw new InvalidDataException("EventDate is a required property for ServiceEventsAttr and cannot be null");
            }
            else
            {
        ...
        {
            return this.Equals(input as ServiceEventsAttr);
        }

        /// <summary>
        /// Returns true if ServiceEventsAttr instances are equal
        /// </summary>
        /// <param name="input">Instance of ServiceEventsAttr to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ServiceEventsAttr input)
        {
            if (input == null)
                return false;
